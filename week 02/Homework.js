...
console.log(x);
x = 3;
console.log('the value of x will be: two');
console.log(x);
...
console.log('Type of variable a is: ' + typeof String);
...
if (typeof a == typeof q) {
  console.log('a and q are the same type');
} else {
  console.log('a and q are NOT the same type');
}
